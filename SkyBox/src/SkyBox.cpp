...
{
    m_images[0] = QImage(":/assets/bg.jpg").convertToFormat(QImage::Format_RGB888).scaled(2048,2048);
    m_images[1] =QImage(":/assets/bg.jpg").convertToFormat(QImage::Format_RGB888).scaled(2048,2048);
    m_images[2] = QImage(":/assets/bg.jpg").convertToFormat(QImage::Format_RGB888).scaled(2048,2048);
    m_images[3] = QImage(":/assets/bg.jpg").convertToFormat(QImage::Format_RGB888).scaled(2048,2048);
    m_images[4] = QImage(":/assets/bg.jpg").convertToFormat(QImage::Format_RGB888).scaled(2048,2048);
    m_images[5] = QImage(":/assets/bg.jpg").convertToFormat(QImage::Format_RGB888).scaled(2048,2048);
    ...
    //    for (int i = 0; i < 6; ++i) {
    //        m_texture.setData(0, 0, static_cast<QOpenGLTexture::CubeMapFace>(QOpenGLTexture::CubeMapPositiveX + i), QOpenGLTexture::RGB, QOpenGLTexture::UInt8, m_images[i].bits());
    //    }
