...
void Cube::initBuffer()
{
    ...
    VertexData vertices[] = {
        ...
        {QVector3D(-2.5f, -0.05f,  0.05f), QVector2D(0.0f, 0.0f)},  // v0
        {QVector3D( 2.5f, -0.05f,  0.05f), QVector2D(0.33f, 0.0f)}, // v1
        {QVector3D(-2.5f,  0.05f,  0.05f), QVector2D(0.0f, 0.5f)},  // v2
        {QVector3D( 2.5f,  0.05f,  0.05f), QVector2D(0.33f, 0.5f)}, // v3

        // Vertex data for face 1
        {QVector3D(2.5f, -0.05f,  0.05f), QVector2D( 0.0f, 0.5f)}, // v4
        {QVector3D( 2.5f, -0.05f, -0.05f), QVector2D(0.33f, 0.5f)}, // v5
        {QVector3D( 2.5f,  0.05f,  0.05f), QVector2D(0.0f, 1.0f)},  // v6
        {QVector3D( 2.5f,  0.05f, -0.05f), QVector2D(0.33f, 1.0f)}, // v7

        // Vertex data for face 2
        {QVector3D( 2.5f, -0.05f, -0.05f), QVector2D(0.66f, 0.5f)}, // v8
        {QVector3D(-2.5f, -0.05f, -0.05f), QVector2D(1.0f, 0.5f)},  // v9
        {QVector3D(2.5f,  0.05f, -0.05f), QVector2D(0.66f, 1.0f)}, // v10
        {QVector3D(-2.5f,  0.05f, -0.05f), QVector2D(1.0f, 1.0f)},  // v11

        // Vertex data for face 3
        {QVector3D(-2.5f, -0.05f, -0.05f), QVector2D(0.66f, 0.0f)}, // v12
        {QVector3D(-2.5f, -0.05f,  0.05f), QVector2D(1.0f, 0.0f)},  // v13
        {QVector3D(-2.5f,  0.05f, -0.05f), QVector2D(0.66f, 0.5f)}, // v14
        {QVector3D(-2.5f,  0.05f,  0.05f), QVector2D(1.0f, 0.5f)},  // v15

        // Vertex data for face 4
        {QVector3D(-2.5f, -0.05f, -0.05f), QVector2D(0.33f, 0.0f)}, // v16
        {QVector3D( 2.5f, -0.05f, -0.05f), QVector2D(0.66f, 0.0f)}, // v17
        {QVector3D(-2.5f, -0.05f,  0.05f), QVector2D(0.33f, 0.5f)}, // v18
        {QVector3D( 2.5f, -0.05f,  0.05f), QVector2D(0.66f, 0.5f)}, // v19

        // Vertex data for face 5
        {QVector3D(-2.5f,  0.05f,  0.05f), QVector2D(0.33f, 0.5f)}, // v20
        {QVector3D( 2.5f,  0.05f,  0.05f), QVector2D(0.66f, 0.5f)}, // v21
        {QVector3D(-2.5f,  0.05f, -0.05f), QVector2D(0.33f, 1.0f)}, // v22
        {QVector3D( 2.5f,  0.05f, -0.05f), QVector2D(0.66f, 1.0f)},
    };
    ...
    GLushort indices[] = {
        ...
        0+24,  1+24,  2+24,  3+24,  3+24,     // Face 0 - triangle strip ( v0,  v1,  v2,  v3)
        4+24,  4+24,  5+24,  6+24,  7+24,  7+24, // Face 1 - triangle strip ( v4,  v5,  v6,  v7)
        8+24,  8+24,  9+24, 10+24, 11+24, 11+24, // Face 2 - triangle strip ( v8,  v9, v10, v11)
        12+24, 12+24, 13+24, 14+24, 15+24, 15+24, // Face 3 - triangle strip (v12, v13, v14, v15)
        16+24, 16+24, 17+24, 18+24, 19+24, 19+24, // Face 4 - triangle strip (v16, v17, v18, v19)
        20+24, 20+24, 21+24, 22+24, 23+24 ,
    };
